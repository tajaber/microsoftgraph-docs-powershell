...
### Create
```
New-MgServicePrincipal -BodyParameter <IMicrosoftGraphServicePrincipal> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
[!INCLUDE [permissions-table](~/../graphref/api-reference/v1.0/includes/permissions/serviceprincipal-post-serviceprincipals.md)]
