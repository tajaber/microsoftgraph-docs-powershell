...
Add-MgGroupSite -GroupId <String>
 -BodyParameter <IPathsZv3WsxGroupsGroupIdSitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1>
 [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
```yaml
Type: IPathsZv3WsxGroupsGroupIdSitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1
...
### Microsoft.Graph.PowerShell.Models.IPathsZv3WsxGroupsGroupIdSitesMicrosoftGraphAddPostRequestbodyContentApplicationJsonSchema1
## OUTPUTS
