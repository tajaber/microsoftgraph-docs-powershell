...
function WebScrapping {
    ...
    $PermissionsLink = "[!INCLUDE [permissions-table](~/../graphref/api-reference/$GraphProfile/includes/permissions/$LastExternalDocUrlPathSegmentWithoutQueryParam.md)]"
   
    Write-Host "`n$PermissionsLink"
    try {
